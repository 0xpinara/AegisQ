...
We draw the obvious conclusion rather than working around it: on this host
most wall-time differences between placements are not resolvable, and we do
not report them as speedups. The placement result is the traffic reduction.
...
removes \aegisqQftTraffic{} of the traffic. Its wall time falls by
\aegisqQftWall, but that change does not clear the noise floor and we do not
claim it. Grover's dense

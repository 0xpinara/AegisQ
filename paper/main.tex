...
Measured at 8 ranks, windowed placement beats the best single assignment on
four of five families: $95.7\%$ of baseline traffic removed for the QFT
against $87.2\%$ static, and $87.1\%$ against $72.3\%$ for Grover. On GHZ,
...
together ($53.1\%$) rather than from windowing ($42.9\%$), so no single lever
dominates.

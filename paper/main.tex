...
choice deliberately. Every byte the runtime hands to MPI is instrumented, an
...
\item A \textbf{compiler} comprising an analytical communication cost model and
  a placement search.
...
account for the interconnect a job is actually running on.

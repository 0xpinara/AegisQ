...
local position a qubit occupies. Measured across target positions, that holds
for the full-sweep kernels and for \texttt{cx} (spread under $6\%$), and
fails for \texttt{cz}, whose achieved bandwidth varies by $57\%$ with the
target position. The model is therefore accurate about network traffic and
...
\aegisqEnvelopeOverhead{} of runtime.

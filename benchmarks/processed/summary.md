...
- AegisQ 0.1.0 at commit `1f1a8dbb776e`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|:--:|
| ghz | 20 | 2 | 8,388,608 | 8,388,608 | 0.0% | 0.009 | 0.007 | -15.5% | no |
| ghz | 20 | 4 | 16,777,216 | 16,777,216 | 0.0% | 0.010 | 0.011 | +7.5% | no |
| ghz | 20 | 8 | 25,165,824 | 25,165,824 | 0.0% | 0.015 | 0.011 | -30.8% | no |
| grover | 20 | 2 | 536,870,912 | 150,994,944 | 71.9% | 0.449 | 0.386 | -13.9% | no |
| grover | 20 | 4 | 1,207,959,552 | 301,989,888 | 75.0% | 0.418 | 0.379 | -9.3% | yes |
| grover | 20 | 8 | 1,879,048,192 | 520,093,696 | 72.3% | 0.468 | 0.442 | -5.5% | no |
| ising | 20 | 2 | 150,994,944 | 83,886,080 | 44.4% | 0.117 | 0.106 | -9.6% | no |
| ising | 20 | 4 | 301,989,888 | 234,881,024 | 22.2% | 0.113 | 0.121 | +6.8% | no |
| ising | 20 | 8 | 452,984,832 | 385,875,968 | 14.8% | 0.178 | 0.152 | -14.4% | no |
| qft | 20 | 2 | 343,932,928 | 25,165,824 | 92.7% | 0.290 | 0.303 | +4.5% | no |
| qft | 20 | 4 | 671,088,640 | 67,108,864 | 90.0% | 0.317 | 0.265 | -16.4% | yes |
| qft | 20 | 8 | 981,467,136 | 125,829,120 | 87.2% | 0.298 | 0.257 | -13.6% | no |
| random | 20 | 2 | 159,383,552 | 83,886,080 | 47.4% | 0.092 | 0.096 | +4.3% | no |
| random | 20 | 4 | 251,658,240 | 167,772,160 | 33.3% | 0.103 | 0.092 | -10.9% | yes |
| random | 20 | 8 | 411,041,792 | 251,658,240 | 38.8% | 0.136 | 0.122 | -9.8% | no |
...
|---|---:|---|---:|---:|---:|---:|---:|
| ising | 22 | one-thread-per-rank | 1 | 1 | 1.815 | 1.00x | 100% |
| ising | 22 | one-thread-per-rank | 2 | 1 | 0.961 | 1.89x | 94% |
| ising | 22 | one-thread-per-rank | 4 | 1 | 0.681 | 2.66x | 67% |
| ising | 22 | one-thread-per-rank | 8 | 1 | 0.750 | 2.42x | 30% |
| qft | 22 | one-thread-per-rank | 1 | 1 | 5.211 | 1.00x | 100% |
| qft | 22 | one-thread-per-rank | 2 | 1 | 2.765 | 1.88x | 94% |
| qft | 22 | one-thread-per-rank | 4 | 1 | 1.907 | 2.73x | 68% |
| qft | 22 | one-thread-per-rank | 8 | 1 | 1.988 | 2.62x | 33% |

## Weak scaling (measured)

| circuit | thread policy | ranks | qubits | amplitudes/rank | wall (s) | efficiency |
|---|---|---:|---:|---:|---:|---:|
| ising | one-thread-per-rank | 1 | 20 | 1,048,576 | 0.413 | 100% |
| ising | one-thread-per-rank | 2 | 21 | 1,048,576 | 0.448 | 92% |
| ising | one-thread-per-rank | 4 | 22 | 1,048,576 | 0.660 | 63% |
| ising | one-thread-per-rank | 8 | 23 | 1,048,576 | 1.488 | 28% |
